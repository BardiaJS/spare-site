...
<x-layout>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    ...
                    <div class="page-header text-center mb-5">
                        ...
                        <h1 class="page-title">ویرایش برند</h1>
                        <p class="page-subtitle">اطلاعات برند را به روزرسانی کنید</p>
                        
                        <!-- اطلاعات برند فعلی -->
                        <div class="current-info mt-4">
                            <div class="info-badge">
                                <i class="fas fa-tag me-2"></i>
                                در حال ویرایش: <strong>{{ $brand->name }}</strong>
                            </div>
                        </div>
                    </div>

                    <!-- فرم ویرایش برند -->
                    <div class="edit-brand-card">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/edit-brand/brand/{{$brand->id}}" method="POST" id="registration-form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-section mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input name="name" id="category-code-register" class="form-control" type="text" 
                                                   placeholder="نام برند را وارد کنید" autocomplete="off" value="{{$brand->name}}" />
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="form-text text-muted mt-2">
                                            ...
                                            نام برند باید منحصر به فرد و واضح باشد
                                        </div>
                                    </div>

                                    <!-- آمار برند -->
                                    <div class="brand-stats mb-4">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="stat-card">
                                                    ...
                                                    <div class="stat-content">
                                                        <h3 class="stat-number">{{ $brand->products->count() }}</h3>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="stat-card">
                                                    ...
                                                    <div class="stat-content">
                                                        <h3 class="stat-number">{{ $brand->created_at->diffForHumans() }}</h3>
                                            ...
                                            <div class="card border-info">
                                                <div class="card-body py-3">
                                                    <h6 class="card-title text-info mb-2">
                                                        <i class="fas fa-lightbulb me-2"></i>راهنمای انتخاب نام برند
                                                    </h6>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled mb-0">
                                                                <li class="mb-1">
                                                                    ...
                                                                    کوتاه و memorable باشد
                                                                </li>
                                                                <li class="mb-1">
                                                                    <i class="fas fa-check text-success me-2 small"></i>
                                                                    مرتبط با محصولات باشد
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-6">
                    ...
                    <div class="important-notes mt-4">
                        <div class="alert alert-warning">
                            ...
                            <ul class="mb-0 ps-3">
                                <li class="mb-1">تغییر نام برند بر روی تمام محصولات این برند تأثیر می‌گذارد</li>
    ...
    <script>
        function resetForm() {
            document.getElementById('category-code-register').value = '{{ $brand->name }}';
        }
        
        document.addEventListener('DOMContentLoaded', function() {
            const brandNameInput = document.getElementById('category-code-register');
            ...
            document.getElementById('registration-form').addEventListener('submit', function(e) {
                ...
                if (brandName.length < 2) {
                    e.preventDefault();
                    alert('نام برند باید حداقل ۲ کاراکتر باشد');
                ...
                if (brandName.length > 50) {
                    e.preventDefault();
                    alert('نام برند نباید بیش از ۵۰ کاراکتر باشد');
                    brandNameInput.focus();
                    return false;
                }
            });
            ...
            brandNameInput.addEventListener('input', function(e) {
