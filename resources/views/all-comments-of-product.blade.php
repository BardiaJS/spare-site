        ...
        <div class="text-center">
            ...
            <p> {{$comment->body}}
                @if(($comment->customer_id == Auth::user()->customer->id))
                    <form action="/edit-comment/form/{{$comment->id}}" method="GET">
                        <button title="edit">
                ...
                @if(!$isBanned)
                    <form action="/ban-user/user/{{$comment->customer->user->id}}" method="POST">
                        @csrf
                        <button title="ban">
                ...
                @else
                    <form action="/unban-user/user/{{$comment->customer->user->id}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button title="unban">
