<x-layout>
    ...
    <div class="text-center" style="font-weight: bold; font-size: 20px;">
      <p class="m-0 small shadow-sm" style="color: red">No Production</p>
    </div> 
    @else
            ...
            <a href="/single-product/product/{{$product->id}}" class="list-group-item list-group-item-action">
              ...
              <span style="font-weight: bold; color: #58A0C8; font-size: 18px;">{{$product->title}}</span></h4>
               <p><strong style="color: #113F67; font-size:20px">
                    ...
                    Information: </strong><span style="color: #58A0C8; font-weight: bold; font-size: 18px;">{{$product->information}}<span></p>
               ...
               <p><strong style="color: #113F67; font-size: 20px;">
                ...
                Value: </strong><span style="color: #58A0C8; font-weight: bold; font-size: 18px;">{{$product->value}} T</span></p>
               ...
               @if((bool)Auth::user()->customer)
                  <form action="/add-to-order/product/{{$product->id}}" method="POST">
                    ...
                    <button class="btn" style="background-color: #113F67; color: #FDF5AA;">Add to purchase box</button>
                  </form>
               @endif
               {{-- <a href="">
                {{$product->brand->name}}
